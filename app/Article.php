...
class Article extends Table{
    ...
    public static function setArticle($titre, $apercu, $contenu, $en_ligne, $publier_par){
        self::prepare("INSERT INTO articles(titre, apercu, contenu, en_ligne, publier_par) VALUES(?, ?, ?, ?, ?)", [$titre, $apercu, $contenu, $en_ligne, $publier_par]);
        return true;
    }
    ...
    public static function updateArticle($id, $titre, $apercu, $contenu, $en_ligne){
        self::prepare("UPDATE articles SET titre = ?, apercu = ?, contenu = ?, en_ligne = ? WHERE id = $id", [$id, $titre, $apercu, $contenu, $en_ligne]);
    }
