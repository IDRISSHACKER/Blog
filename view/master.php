...
<body>
    <div class="navbar">
        <div class="navbar-brand">
            <a href="index.php?page=home" class="logo">DDES</a>
        </div>
        <ul class="navbar-link">
            ...
            <?php if (!empty($_SESSION['id'])) { ?>
                <li>
                    <a href="index.php?page=upload" class="btn btn-primary">Creer un article</a>
                </li>
                <li>
        ...
        <div class="container">
            <?php if (!empty($_SESSION['id'])) { ?>
                <div class="area floating btn">
                    <div class="user-info"><?= $_SESSION['id']['nom'] ?> </div>
                </div>
            <?php } ?>
            <div class="msg">
                <?php if (@$err) { ?>
